...
class TestArithmeticTokenizer:
    ...
    def test_simple_encoding(self, tokenizer: ArithmeticTokenizer):
    ...
    def test_simple_decoding(self, tokenizer: ArithmeticTokenizer):
    ...
    def test_batch_decoding(self, tokenizer: ArithmeticTokenizer):
    ...
    def test_roundtrip_consistency(self, tokenizer: ArithmeticTokenizer):
    ...
    def test_invalid_character_encoding(self, tokenizer: ArithmeticTokenizer):
    ...
    def test_invalid_token_id_decoding(self, tokenizer: ArithmeticTokenizer):
        """Test decoding raises error for invalid token IDs."""
        # Ignores invalid token
        assert tokenizer.decode([3, 10, 5, 99]) == "3+5"

    def test_reasoning_tokens(self, tokenizer: ArithmeticTokenizer):
    ...
    def test_chain_of_thought_example(self, tokenizer: ArithmeticTokenizer):
    ...
    def test_edge_cases(self, tokenizer: ArithmeticTokenizer):
    ...
    def test_large_numbers(self, tokenizer: ArithmeticTokenizer):
